...
export declare namespace cloudscheduler_v1beta1 {
    ...
    interface Schema$AppEngineHttpTarget {
         ...
         * the   modified `User-Agent`.  If the job has an body, Cloud Scheduler
         * sets the following headers:  * `Content-Type`: By default, the
         ...
         * use only. * `X-AppEngine-*`: For Google internal use only. See   [Reading
         * request
    ...
    class Resource$Projects$Locations$Jobs {
         ...
         * @return {object} Request object
         */
        delete(params?: Params$Resource$Projects$Locations$Jobs$Delete, options?: MethodOptions): AxiosPromise<Schema$Empty>;
         ...
         * @return {object} Request object
         */
        patch(params?: Params$Resource$Projects$Locations$Jobs$Patch, options?: MethodOptions): AxiosPromise<Schema$Job>;
         ...
         * @return {object} Request object
         */
        pause(params?: Params$Resource$Projects$Locations$Jobs$Pause, options?: MethodOptions): AxiosPromise<Schema$Job>;
         ...
         * @return {object} Request object
         */
        resume(params?: Params$Resource$Projects$Locations$Jobs$Resume, options?: MethodOptions): AxiosPromise<Schema$Job>;
         ...
         * @return {object} Request object
         */
        run(params?: Params$Resource$Projects$Locations$Jobs$Run, options?: MethodOptions): AxiosPromise<Schema$Job>;
