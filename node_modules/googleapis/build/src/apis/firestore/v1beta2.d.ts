...
export declare namespace firestore_v1beta2 {
    ...
    class Resource$Projects$Databases$Collectiongroups$Indexes {
         ...
         * @return {object} Request object
         */
        list(params?: Params$Resource$Projects$Databases$Collectiongroups$Indexes$List, options?: MethodOptions): AxiosPromise<Schema$GoogleFirestoreAdminV1beta2ListIndexesResponse>;
