...
export declare namespace dataflow_v1b3 {
    ...
    class Resource$Projects$Jobs {
         ...
         * @return {object} Request object
         */
        snapshot(params?: Params$Resource$Projects$Jobs$Snapshot, options?: MethodOptions): AxiosPromise<Schema$Snapshot>;
    ...
    class Resource$Projects$Locations$Jobs {
         ...
         * @return {object} Request object
         */
        snapshot(params?: Params$Resource$Projects$Locations$Jobs$Snapshot, options?: MethodOptions): AxiosPromise<Schema$Snapshot>;
