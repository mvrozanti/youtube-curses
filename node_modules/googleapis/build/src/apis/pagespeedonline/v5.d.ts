...
export declare namespace pagespeedonline_v5 {
    ...
    interface Schema$LighthouseResultV5 {
         ...
         */
        categories?: {
            [key: string]: Schema$LighthouseCategoryV5;
        };
        /**
    ...
    class Resource$Pagespeedapi {
         ...
         */
        runpagespeed(params?: Params$Resource$Pagespeedapi$Runpagespeed, options?: MethodOptions): AxiosPromise<Schema$PagespeedApiPagespeedResponseV5>;
